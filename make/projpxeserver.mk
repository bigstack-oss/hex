...
pxeserver_build:
	...
	$(Q)nohup md5sum < $(PROJ_PXESERVER) > $(PROJ_SHIPDIR)/$(PROJ_PXESERVER_LONGNAME).md5 2>&1 &
	$(Q)nohup sha256sum < $(PROJ_PXESERVER) > $(PROJ_SHIPDIR)/$(PROJ_PXESERVER_LONGNAME).sha256 2>&1 &
