...
pxeserver_iso_build:
	...
	$(Q)nohup md5sum < $(PROJ_PXESERVER_ISO) > $(PROJ_SHIPDIR)/$(PROJ_PXESERVER_ISO_LONGNAME).md5 &
	$(Q)nohup sha256sum < $(PROJ_PXESERVER_ISO) > $(PROJ_SHIPDIR)/$(PROJ_PXESERVER_ISO_LONGNAME).sha256 &
